...
<body>
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-sm-12">
						<section class="panel">
							<header class="panel-heading mi-panel-heading"> Nuevo
								pase </header>
										...
										<div class="navbar-inner">
											<div class="container">
												<ul>
													...
													<li><a href="#tab3" data-toggle="tab">Crear dependencias</a></li>
												</ul>
											</div>
										</div>
									</div>
	...
	<script type="text/javascript"
		src="${pageContext.servletContext.contextPath}/resources/js/bootstrap-fileupload/bootstrap-fileupload.js"></script>
	<script type="text/javascript"
