...
<head>
    ...
    <!--external css-->
    <link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/resources/js/fuelux/css/tree-style.css" />
...
<!--tree-->
<script src="${pageContext.servletContext.contextPath}/resources/js/fuelux/js/tree.min.js"></script>
...
<script src="${pageContext.servletContext.contextPath}/resources/js/tree.js"></script>
