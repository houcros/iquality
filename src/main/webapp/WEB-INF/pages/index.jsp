...
<head>
    ...
    <meta http-equiv=â€X-UA-Compatibleâ€ content=â€IE=EmulateIE9â€>
    <meta http-equiv=â€X-UA-Compatibleâ€ content=â€IE=9â€>
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="${pageContext.servletContext.contextPath}/resources/images/avatar-mini.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="${pageContext.servletContext.contextPath}/resources/images/avatar-mini-2.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="${pageContext.servletContext.contextPath}/resources/images/avatar-mini-3.jpg"></span>
                                <span class="subject">
                    ...
                    <ul class="conversation-list">
                        <li class="clearfix">
                            <div class="chat-avatar">
                                <img src="${pageContext.servletContext.contextPath}/resources/images/chat-user-thumb.png" alt="male">
                                <i>10:00</i>
                            </div>
                        ...
                        <li class="clearfix odd">
                            <div class="chat-avatar">
                                <img src="${pageContext.servletContext.contextPath}/resources/images/chat-user-thumb-f.png" alt="female">
                                <i>10:00</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
...
<div class="row">
    <div class="col-md-8">
        <section class="panel">
            <div class="wdgt-row">
                <img src="${pageContext.servletContext.contextPath}/resources/images/weather_image.jpg" height="243" alt="">
                <div class="wdt-head">
                    weather forecast
                </div>
        ...
        <li>
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="${pageContext.servletContext.contextPath}/resources/images/avatar1_small.jpg" alt=""></a>
                </div>
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="${pageContext.servletContext.contextPath}/resources/images/avatar1.jpg" alt=""></a>
                </div>
                <div class="user-details">
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="${pageContext.servletContext.contextPath}/resources/images/chat-avatar2.jpg" alt=""></a>
                </div>
                <div class="user-details">
