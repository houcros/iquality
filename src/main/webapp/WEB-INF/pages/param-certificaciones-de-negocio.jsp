...
<head>
    ...
    <title>Condiciones de certificaciones de negocio</title>
...
<%-- 												<li><a href=${requestScope['javax.servlet.forward.request_uri']}${'/2'}>Validaciones t&eacute;cnicas</a></li> --%>
												<li><a href="${pageContext.servletContext.contextPath}/parametrizar-certificaciones/2">Validaciones</a></li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="panel-body">
								...
								<div class="clearfix">
										<div class="btn-group">
											<a
												href="${pageContext.servletContext.contextPath}/parametrizar-certificaciones/wizard-nueva-certificacion">
